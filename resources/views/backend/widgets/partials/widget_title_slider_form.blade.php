...
<div class="col-sm-12">
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="custom_detail[title_1]" value="{{ isset($details['custom_detail']['title_1']) ? $details['custom_detail']['title_1'] : '' }}" />
    </div>
</div>
...
<div class="col-sm-12">
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="custom_detail[title_2]" value="{{ isset($details['custom_detail']['title_2']) ? $details['custom_detail']['title_2'] : '' }}" />
    </div>
</div>
