...
@section('section')
    ...
    <main>
        ...
        @include('frontend.layouts.partials.breadcrumb', ['breadcrumbTitle' => 'Bảng giá'])

        <section class="content">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="title_sub">BẢNG GIÁ</h2>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered table_banggia">
                                        <thead>
                                        <tr>
                                            <th>GÓI DỊCH VỤ</th>
                                            <th>KHU VỰC TP.HCM</th>
                                            <th>CƯỚC PHÍ (VNĐ)</th>
                                            <th>MÔ TẢ</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
                                            <td><b>GIAO QUA NGÀY</b></td>
                                            <td style="padding: 0; vertical-align: top;">
                                                <table class="table">
                                                    <tr><td>Nội thành</td></tr>
                                                    <tr><td>Ngoại thành</td></tr>
                                                    <tr><td>Huyện</td></tr>
                                                </table>
                                            </td>
                                            <td style="padding: 0; vertical-align: top;">
