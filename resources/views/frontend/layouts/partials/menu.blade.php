                        ...
                        <ul class="list_menuTop">
                            <li>
                                ...
                                <ul class="dropdown-menu">
                                    <li class="{{ (request()->is('account') ? 'active' : '') }}"><a href="{{ action('Frontend\UserController@editAccount') }}"><i class="fa fa-info-circle" aria-hidden="true"></i> Thông tin tài khoản</a></li>
